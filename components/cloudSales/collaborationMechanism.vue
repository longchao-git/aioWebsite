      ...
      <div class='_bottom'>
        ...
        <div class='_right'>
          ...
          <dl>
            ...
            <dd @mouseover='currentStepsIndex = 1' @click='currentStepsIndex = 1'
        ...
        <div class='_right'>
          ...
          <dl>
            ...
            <dd @mouseover='currentStepsIndex = 1' @click='currentStepsIndex = 1'
              ...
              <div>
                <div>
                  <span>{{ $t('indexTwo.twoBoot') }} </span>
                </div>
              </div>
            </dd>
            <dd @mouseover='currentStepsIndex = 2' @click='currentStepsIndex = 2'
...
.cloud_sales_sales-collaboration-mechanism {
  position: relative;
  background: #fff;
  display: flex;
      ...
      dl {
        ...
        .selected {
          > div {
            ...
            background: linear-gradient(90deg, #ff797c, #ecf3ff, #ffffff) !important;
